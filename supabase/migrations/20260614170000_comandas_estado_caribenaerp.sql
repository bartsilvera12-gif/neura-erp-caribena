-- =============================================================================
-- Comandas: estado de cocina + módulo "Comandas" — SOLO schema `caribenaerp`.
--
-- Agrega flujo de cocina a caribenaerp.comandas (enviada → en_preparacion → lista
...
WHERE NOT EXISTS (SELECT 1 FROM caribenaerp.modulos WHERE slug = 'comandas');
