-- =============================================================================
-- Módulo MESAS — soporte "Para llevar" / Retiro (SOLO schema `caribenaerp`).
--
...
-- -----------------------------------------------------------------------------
-- DO $$
-- DECLARE sch text := 'caribenaerp';
-- BEGIN
--   -- Bloquear rollback si hay sesiones PL vivas (evita corrupción de datos).
--   IF EXISTS (SELECT 1 FROM caribenaerp.mesa_sesiones WHERE tipo = 'para_llevar') THEN
