      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-stretch">
        <div className="flex-1 min-w-0 space-y-5">
          ...
          {!loadingResumen && resumen && (
            ...
            {/* Aviso "envío por correo apagado" ocultado a pedido: el SMTP se
                configura aparte. Se mantiene la lógica de mail (bloque de envío
                de abajo, que sólo aparece cuando el correo está configurado). */}
