/**
 * Smoke test post-migración — Módulo CAJA por turno (Caribeña / schema caribenaerp).
 *
 * Valida, de forma SEGURA, que la migración `…_modulo_caja_turno_caribenaerp.sql`
 ...
 *   SMOKE_EMAIL / SMOKE_PASSWORD   credenciales de un usuario de la empresa caribenaerp
 ...
 *   Producción (dry):   SMOKE_BASE_URL=https://caribenaerp.neura.com.py SMOKE_EMAIL=... SMOKE_PASSWORD=... npm run smoke:caja
...
async function main() {
  console.log("════════════════════════════════════════════════════════════");
  console.log(" SMOKE TEST · Módulo CAJA por turno · schema caribenaerp");
  console.log("════════════════════════════════════════════════════════════");
